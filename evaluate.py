...
import numpy as np
import torch
from geometry import score_scan
...
def main():
    ...
    p.add_argument('--method', choices=('longterm', 'nr_rec_fus'))
    ...
    for row in selected:
        ...
        metrics = score_scan(prediction, tforms, landmarks, chunk_size=a.chunk_size)
